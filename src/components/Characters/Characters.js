...
const Characters = (props) => {
    ...
    props.data.forEach(character => {
        ...
        if (props.femaleGender && character.gender !== "femme"){
               return} // si la selection femele est true mais que le character n'est pas un homme, ne return rien
        if (props.robotGender && character.gender !== "robot"){
                return} // si la selection robot est true mais que le character n'est pas un homme, ne return rien
